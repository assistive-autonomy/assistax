...
# FILL-TO-630: teethbrushing MAPPO top-up (+210 humans). Mirrors mappo_ff_teeth_zoo.sh;
# only SEED (fresh 23/24/25) and the per-job shard dir differ (the source's duplicated
# reward_budget line is collapsed to one). Seeds 23/24/25 shared with bb/feeding fills.
set -Eeuo pipefail
