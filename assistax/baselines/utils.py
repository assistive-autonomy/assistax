...
# _tree_take, _tree_shape, _unstack_tree and _stack_tree live in the dependency-free
# tree_utils module so they can be shared with assistax.wrappers.aht without a cycle.
from assistax.baselines.tree_utils import (
    _tree_take, _tree_shape, _unstack_tree, _stack_tree,
)
