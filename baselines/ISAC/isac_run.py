...
# def _generate_episode_visualizations(config: Dict, evaluation_results: Dict) -> Dict:
#     """
#     Generate HTML visualizations of best, worst, and median ISAC episodes.
...
#     evals = evaluation_results["evals"]
#     eval_env = evaluation_results["eval_env"]
    
#     # Process episodes to find best, worst, and median
#     first_episode_done = jnp.cumsum(evals.done["__all__"], axis=0, dtype=bool)
#     first_episode_returns = _compute_episode_returns(evals)["__all__"]
...
#         evals.env_state.env_state.pipeline_state, 
#         first_episode_done,
#         time_idx=-1, 
#         eval_idx=worst_idx,
#     )
...
#     # Generate HTML visualizations with return values in filenames
#     try:
...
#         print(f"ISAC episode visualizations generated:")
#         print(f"  ✓ Worst episode (return: {worst_return}) → final_worst_r{worst_return}.html")
#         print(f"  ✓ Median episode (return: {median_return}) → final_median_r{median_return}.html")
#         print(f"  ✓ Best episode (return: {best_return}) → final_best_r{best_return}.html")
...
#             "files": [
#                 f"final_worst_r{worst_return}.html",
#                 f"final_median_r{median_return}.html", 
#                 f"final_best_r{best_return}.html"
#             ]
#         }
        
#     except Exception as e:
#         print(f"Error generating ISAC visualizations: {e}")
